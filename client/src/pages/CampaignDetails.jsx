    ...
    <div>
      ...
      <div className="w-full flex md:flex-row flex-col mt-10 gap-[30px]">
        <div className="flex-1 flex-col">
          <img src={state.image} alt="campaign" className="w-full h-[510px] object-cover rounded-xl"/>
      ...
      <div className="mt-[60px] flex lg:flex-row flex-col gap-5">
        ...
        <div className="flex-1">
          <h4 className="font-epilogue font-bold text-[28px] text-black uppercase text-center">Fund</h4>   
          ...
          <div className="mt-[20px] flex flex-col p-4 bg-[#1c1c24] rounded-[10px]">
            ...
            <div className="mt-[30px]">
              ...
              <div className="my-[20px] p-4 bg-[#13131a] rounded-[10px]">
                <h4 className="font-epilogue font-semibold text-[14px] leading-[22px] text-white">Believe in the cause, crowdfund it.</h4>
                <p className="mt-[20px] font-epilogue font-normal leading-[22px] text-[#ffffff]">Choose to support the project out of personal affinity, without anticipation of any reward.</p>
              </div>
