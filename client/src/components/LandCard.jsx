...
const LandCard = ({ land, onBuyProperty, onListForSale }) => {
  return (
    <div className="bg-gray-800 border-2 border-gray-700 rounded-[2rem] shadow-lg transition duration-300 ease-in-out hover:shadow-2xl hover:border-purple-600 transform hover:-translate-y-3 hover:scale-105">
      <div className="p-6">
        <div className="space-y-5">
          ...
          <div className="space-y-3">
            ...
            <div className="flex justify-between items-center">
              ...
              <span className="text-gray-100 font-semibold">{land.area} sq. meters</span>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-gray-400 font-medium">Price</span>
              <span className="text-green-400 font-bold text-lg">{land.price} ETH</span>
            </div>
            <div className="flex justify-between items-center pt-2 border-t border-gray-700">
              <span className="text-gray-400 font-medium">Availability</span>
              <span className={`font-bold text-base ${land.isForSale ? 'text-green-400' : 'text-red-400'}`}>
